...
const services = [
  {
    ...
    description:
      "Transformez votre espace extérieur grâce au service de construction de patios de Grosor Inc. Nous vous proposons des designs élégants et des installations durables pour créer des patios accueillants et fonctionnels. Offrez-vous un véritable havre de paix tout près de chez vous, où chaque instant se transforme en une expérience inoubliable.",
  },
  {
    name: "Deck",
